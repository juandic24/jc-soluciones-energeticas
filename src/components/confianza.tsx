...
export function Confianza() {
  return (
    ...
    >
      <div className="pointer-events-none absolute -left-20 top-1/2 h-80 w-80 -translate-y-1/2 rounded-full bg-navy-500/20 blur-3xl" />
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {site.confianza.map((c) => {
            ...
            return (
              ...
              >
                <div className="flex size-12 items-center justify-center rounded-xl bg-amber-500 text-navy-900">
